 ...
 * @Date: 2024-10-23 10:28:52
 * @LastEditors: sunnydongbowen
 * @LastEditTime: 2024-10-25 14:28:15
 * @FilePath: /GoPrimary/qimi/day02/slice_test.go
 * @Description:
 *
 */
package day02
...
func TestSliceInit(t *testing.T) {
	...
	s[0]=100
	fmt.Println(s)
	fmt.Println(a1) // the array is changed because the slice is a reference to the array
